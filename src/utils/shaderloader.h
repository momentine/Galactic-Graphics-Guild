...
public:
    ...
    static GLuint createShaderProgramEC(const char * vertex_file_path,  const char * tcs_file_path, const char * tes_file_path, const char * fragment_file_path){
        // Create and compile the shaders.
        GLuint vertexShaderID = createShader(GL_VERTEX_SHADER, vertex_file_path);
        GLuint tcsShaderID = createShader(GL_TESS_CONTROL_SHADER, tcs_file_path);
        GLuint tesShaderID = createShader(GL_TESS_EVALUATION_SHADER, tes_file_path);
        GLuint fragmentShaderID = createShader(GL_FRAGMENT_SHADER, fragment_file_path);
